...
![Game Field](../images/rules/MR23_Game_Field.png)
...
![X mark](../images/rules/MR23_X_mark.png)

![Game Objects & Positioning](../images/rules/MR23_inline_image__3_.png)
...
![Stack Rules](../images/rules/MR23_inline_image__1_.png)
...
![Enhancement Cubes](../images/rules/MR23_inline_image__2_.png)
...
| Rule | Restriction |
| --- | --- |
| **Touch a Moving Robot** | You cannot touch your robot when it is moving on the playfield outside of the Loading Zone.<br>**Warning:** The referee will immediately stop the match and record any points gained up to that moment. |
